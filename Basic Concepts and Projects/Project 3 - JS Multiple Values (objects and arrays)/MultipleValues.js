...
// arr1 = ["overwriting"]; // Uncaught TypeError: invalid assignment to const 'arr1'
...
cars[0] = 'Maserati';
console.log(cars); // [ "Maserati", "Jaguar", "Urus" ]
...
console.log("numbers", numbers); // numbers [ 12, 24, 36, <2 empty slots>, 48 ]
...
// `shift()`
arr5.shift(); // remove the first element. This causes all other indices to be reduced by one
// [ 2, 3, 4, 5, 6, 7, 8 ]

arr5.splice(1, 3); // removes 3 elements starting from index value 1 (second position)
// [ 2, 6, 7, 8 ]
